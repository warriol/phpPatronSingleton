...
setDocument = Sizzle.setDocument = function( node ) {
	...
	// IE/Edge & older browsers don't support the :scope pseudo-conn.
...
Expr = Sizzle.selectors = {
	...
	filter: {
		...
		"PSEUDO": function( pseudo, argument ) {
			...
			// pseudo-conn names are case-insensitive
	...
	toggleClass: function( value, stateVal ) {
		...
		return this.each( function() {
			...
			// Toggle whole conn name
				...
				// If the element has a conn name or if we're passed `false`,
