...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 12-06-2023 a las 16:05:33
...
(1, 'Socrates', 41),
(2, 'Pablo Neruda', 20),
(3, 'Gabriel García Márquez', 22),
(4, 'Jorge Luis Borges', 7),
(5, 'Julio Cortázar', 12),
(6, 'Mario Vargas Llosa', 74),
(7, 'Isabel Allende', 74),
(8, 'Octavio Paz', 61),
(9, 'Miguel de Cervantes', 33);
...
(1, 'Confieso que he vivido', 2, 'Libros de literatura', 1, 1974, 1, 29),
(2, 'Residencia en la tierra', 2, 'Libros de literatura', 1, 1933, 1, 31),
(3, 'Cien años de soledad', 3, 'Realismo mágico', 1, 1967, 1, 10),
(4, 'Crónica de una muerte anunciada', 3, 'Novela', 3, 1981, 1, 10),
(5, 'El amor en los tiempos del cólera', 3, 'Romance', 3, 1985, 1, 1),
(6, 'Ficciones', 4, 'Cuentos', 4, 1944, 1, 10),
(7, 'El Aleph', 4, 'Cuentos', 5, 1949, 1, 10),
(8, 'Rayuela', 5, 'Novela', 6, 1963, 1, 10),
(9, 'La ciudad y los perros', 6, 'Novela', 7, 1962, 0, 0),
(10, 'La casa verde', 6, 'Novela', 8, 1965, 1, 9),
(11, 'La casa de los espíritus', 7, 'Realismo mágico', 1, 1982, 0, 0),
(12, 'De amor y de sombra', 7, 'Drama', 3, 1984, 1, 10),
(13, 'Veinte poemas de amor y una canción desesperada', 2, 'Poesía', 3, 1924, 1, 10),
(14, 'Canto general', 2, 'Poesía', 4, 1950, 1, 10),
(15, 'El laberinto de la soledad', 8, 'Ensayo', 5, 1950, 1, 10),
(16, 'Piedra de sol', 8, 'Poesía', 6, 1957, 1, 10),
(17, 'Don Quijote de la Mancha', 9, 'Novela', 7, 1605, 1, 10),
(18, 'La Galatea', 9, 'Novela', 8, 1585, 1, 10);
...
(1, 1, 1, '2023-06-12', NULL),
(4, 11, 1, '2023-06-12', '2023-06-12'),
(5, 10, 1, '2023-06-12', '2023-06-12');
